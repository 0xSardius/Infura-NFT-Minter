...
const init = async () => {
  const imageUrl = await sdk.storeFile({
    metadata:
      "https://mir-s3-cdn-cf.behance.net/project_modules/fs/d2b070113024273.601fe7d5a2cde.jpg",
  });
  const tokenMetadata = await Metadata.openSeaTokenLevelStandard({
    name: "Mordor sword",
    description:
      "This sword was forged in mount doom, and will give its owner super strong powers",
